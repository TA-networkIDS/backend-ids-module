...
# Multi-Class
model_path = os.path.join(os.path.dirname(__file__), '../../trained_models/dnn/1305/model.h5')
label_encoder_path = os.path.join(os.path.dirname(__file__), '../../trained_models/dnn/1305/label_encoder.pkl')
